...
public:
    ...
    {
        switch(int(cmd)) {
            case int(Command::ACT_R):
                return true;
            case int(Command::ACT_W):
                return true;  
            default:
                return false;
        }
    ...
    struct OrgEntry {
        ...
        {  512,  4, {0, 0, 16, 1<<13, 1<<11}}, {  512,  8, {0, 0, 16, 1<<13, 1<<10}}, {  512, 16, {0, 0, 16, 1<<12, 1<<10}},
        {1<<10,  4, {0, 0, 16, 1<<14, 1<<11}}, {1<<10,  8, {0, 0, 16, 1<<14, 1<<10}}, {1<<10, 16, {0, 0, 16, 1<<13, 1<<10}},
        {2<<10,  4, {0, 0, 16, 1<<15, 1<<11}}, {2<<10,  8, {0, 0, 16, 1<<15, 1<<10}}, {2<<10, 16, {0, 0, 16, 1<<14, 1<<10}},
        {4<<10,  4, {0, 0, 16, 1<<16, 1<<11}}, {4<<10,  8, {0, 0, 16, 1<<16, 1<<10}}, {4<<10, 16, {0, 0, 16, 1<<15, 1<<10}},
        {8<<10,  4, {0, 0, 16, 1<<16, 1<<12}}, {8<<10,  8, {0, 0, 16, 1<<16, 1<<11}}, {8<<10, 16, {0, 0, 16, 1<<16, 1<<10}}
    }, org_entry;
